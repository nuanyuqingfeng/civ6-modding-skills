...
| `scripts/art_lookup.py` | ArtDef 引用链查询工具（civ6-art-reference skill） | `python art_lookup.py <关键词> [模板名]           # 查包含关键词的条目及其完整引用链<br>python art_lookup.py --list <模板名> [前缀]      # 列出某模板全部条目（可按前缀过滤）` |
